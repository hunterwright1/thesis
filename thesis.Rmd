...
In discussing behavioral economic concepts I use in for my analysis, I reference
...
- Tversky, Amos; Kahneman, Daniel (1991). Loss Aversion in Riskless Choice: A Reference-Dependent Model
...
count %>%
  ...
  labs(
    x = NULL,
    y = "Attendance",
    title = "Figure 1: Average Daily Gym Attendance, Fall 2024"
  ) +
  theme_bw() +
  theme(
...
Loss aversion stems from an agent's perceived utility from losses and gains relative to a reference point. A reference
