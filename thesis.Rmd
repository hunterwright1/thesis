...
Other similar literature related to gym attendance focuses mainly on incentives. Incentives are another behavioral economic concept originating from Nudge Theory in the book Nudge: Improving Decisions About Health, Wealth, and Happiness by Thaler and Sunstein (2008).

- Add DellaVigna, Stefano and Ulrike Malmendier. 2006. "Paying Not to Go to the Gym."
...
.robust0_pad <- setNames(rep(NA, length(.s1Variables)), .s1Variables)
.robust0_pad[names(.robust0)] <- .robust0
