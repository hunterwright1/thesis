...
$$
\;+\; \beta_4\,\text{DeadWeek}_t \;+\; \beta_5\,\text{FinalsWeek}_t \;+\; \varepsilon_t
$$
...
.s2Variables <- c("Constant", "term_week", "quarterBreak", "quarterWinter", "quarterSpring", "quarterSummer", "dead_week", "finals_week")
```
...
cat("\\begin{center}\n") 
star2 <- stargazer(.model0, .model1, .model0_log, .model1_log,
          type = "latex",
          order = .s2Variables,
          keep = .s2Variables,
          se = list(.robust0, .robust1, .robust0_log, .robust1_log),
          ...
          covariate.labels = c("Intercept", "Week of the Term", "Break", "Winter", "Spring", "Summer", "Week Before Finals", "Finals Week"),
