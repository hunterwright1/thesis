...
The primary literature relating to this thesis is Prospect Theory: An Analysis of Decision Under Risk (1979), by Kahneman and Tversky. This paper serves as a critique of expected utility theory by providing evidence that humans do not act completely rationally when presented with decisions that involve risk. For example, when presented with the following two choices:
...
Though it's difficult for many people to go to the gym, others enjoy it and have no trouble going consistently. I 
